            ...
            for req in request_list:
                if req == RequestTypes.VALUE:
                    fixed_value = self.value_fixed_leg(
                            self.model.swap_rates, 
                            self.model.swap_times, 
                            self.model.year_fracs,
                            self.derivative._fixed_leg,
                            self.model._value_dt,
                    ...
                    floating_value = self.value_float_leg(
                            ...
                            self.model.swap_times, 
                            self.model.year_fracs,
                            self.derivative._float_leg,
                            self.model._value_dt,
                            self.model._interp_type,
                            self.model._interp_type,
                            None)
                    
                    compute_output['value'] = fixed_value + floating_value
